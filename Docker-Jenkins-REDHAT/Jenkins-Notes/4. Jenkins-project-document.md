...
🔹 What Is /var/lib/docker/volumes/?
...
==========================================================================================================================================
#note
# ❌ Problem: No hostname mapping by default
...
# entrypoint: /entrypoint.sh
# This script initializes Jenkins — commonly used to set environment variables, install plugins, trust certificates, etc.


# ✅ Option 1: Use extra_hosts (Manual IP Mapping)
extra_hosts:
...
“Hey, what IP should I use when I try to connect to jenkins.isrd.cair.drdo?”
